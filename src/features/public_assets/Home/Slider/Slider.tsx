    ...
    <section className="w-full relative group">
      ...
      <div className="w-full h-[60vh] md:h-[75vh] lg:h-[88vh] relative">
          ...
          {sliders.map((item, index) => (
            <SwiperSlide key={item.id}>
              <div className="relative w-full h-full overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-cyan-500 via-emerald-500 to-cyan-500" />
                      ...
                      {activeIndex === index && (
                        <div className="max-w-2xl xl:max-w-3xl">
                          ...
                          <motion.div
                            ...
                            className="origin-left w-24 h-1 rounded-full bg-gradient-to-r from-cyan-500 to-emerald-500 mb-6"
                          />
                          ...
                          >
                            <Link
                              href="/login"
                              className="group flex items-center gap-2.5 bg-emerald-600 hover:bg-emerald-700 text-white px-7 py-3.5 rounded-full font-bold text-sm uppercase tracking-wider transition-all duration-300 shadow-lg shadow-emerald-600/30 hover:shadow-emerald-600/50 hover:-translate-y-0.5"
                            >
                              Get Started
                              <ArrowRight
                                size={16}
        ...
        <div className="absolute bottom-14 right-6 md:right-10 z-10 bg-black/30 backdrop-blur-md border border-white/15 rounded-full px-4 py-1.5 hidden md:flex items-center gap-1.5">
          <span className="text-cyan-400 font-black text-sm">{activeIndex + 1}</span>
          ...
          <div className="relative flex items-center h-full">
            ...
            >
              ...
              <span className="relative flex h-2 w-2 shrink-0">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-cyan-200 opacity-80" />
